...
class Assinatura(models.Model):
    ...
    def __str__(self):# isso não é obrigatório
        return self.nome
...
#on_delete=models.CASCADE = quand um dado for deletado todos os que tiverem relação com esse dado tbm será deletado
